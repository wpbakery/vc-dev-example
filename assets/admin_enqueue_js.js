console.log('admin_enqueue_js.js is loaded');
...
window.ViewTestElement = vc.shortcode_view.extend({
	...
	render: function () {
		console.log('ViewTestElement: render method called.');
	...
	ready: function (e) {
		console.log('ViewTestElement: ready method called.');
	...
	changeShortcodeParams: function (model) {
		console.log('ViewTestElement: changeShortcodeParams method called.');
	...
	changeShortcodeParent: function (model) {
		console.log('ViewTestElement: changeShortcodeParent method called.');
		window.ViewTestElement.__super__.changeShortcodeParent.call(this, model);
	},
	deleteShortcode: function (e) {
		console.log('ViewTestElement: deleteShortcode method called.');
		window.ViewTestElement.__super__.deleteShortcode.call(this, e);
	},
	editElement: function (e) {
		console.log('ViewTestElement: editElement method called.');
		window.ViewTestElement.__super__.editElement.call(this, e);
	},
	clone: function (e) {
		console.log('ViewTestElement: clone method called.');
