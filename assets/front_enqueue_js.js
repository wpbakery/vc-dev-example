console.log('front_enqueue_js.js is loaded');
...
window.InlineShortcodeView_test_element = window.InlineShortcodeView.extend({
	...
	render: function () {
		console.log('InlineShortcodeView_test_element: render called.');
	...
	updated: function () {
		console.log('InlineShortcodeView_test_element: updated called.');
	...
	parentChanged: function () {
		console.log('InlineShortcodeView_test_element: parentChanged called.');
